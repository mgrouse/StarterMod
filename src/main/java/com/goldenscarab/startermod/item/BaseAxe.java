...
public class BaseAxe extends ItemAxe
{
	...
	public BaseAxe(ToolMaterial material, float damage, float speed, String unlocalizedName)
	{
	...
	{
		this(material, 8.0F, -3.1F, unlocalizedName);
		// Vanilla damage is 6 for [wood, gold] 8 for everything else.
		// Vanilla speed is -3.1 for iron
	}
